...
def func(t,y):
    ...
    temp=eqn.subs([('g',9.8),('l1',0.3),('l2',0.25),('l3',0.25),('m1',1),('m2',1),('m3',1),('q1_dot',q_dot[0]),('q2_dot',q_dot[1]),('q3_dot',q_dot[2]), ('q1',q[0]),('q2',q[1]),('q3',q[2])])
...
l=0.25*1.2
errored=sp.simplify(D_Calc_error(l))
...
for j in t:
    ...
    v1=kp*(q1_d-q1_cont)+kd*(q1_dot_d-q1_dot_cont)
    v2=kp*(q2_d-q2_cont)+kd*(q2_dot_d-q2_dot_cont)
    v3=kp*(q3_d-q3_cont)+kd*(q3_dot_d-q3_dot_cont)

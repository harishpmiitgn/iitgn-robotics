...
for j in t:
    ...
    v1=(Jm[0]/r[0]*q1_dot_dot_d + (Bm[0]+kb[0]*km[0]/R[0])/r[0]*q1_dot_d)*R[0]/km[0] +eq1[0][0]*q1_dot_dot_d*R[0]/km[0] +kp*(q1_d-q1_cont)+kd*(q1_dot_d-q1_dot_cont)
    v2=(Jm[1]/r[1]*q2_dot_dot_d + (Bm[1]+kb[1]*km[1]/R[1])/r[1]*q2_dot_d)*R[1]/km[1] +eq1[1][0]*q2_dot_dot_d*R[1]/km[1] +kp*(q2_d-q2_cont)+kd*(q2_dot_d-q2_dot_cont)
    v3=(Jm[2]/r[2]*q3_dot_dot_d + (Bm[2]+kb[2]*km[2]/R[2])/r[2]*q3_dot_d)*R[2]/km[2] +eq1[2][0]*q3_dot_dot_d*R[2]/km[2] +kp*(q3_d-q3_cont)+kd*(q3_dot_d-q3_dot_cont)
    ...
    times.append(j)
    # plt.plot(times,xs_d,"blue", label="Desired Y coordinates")
    # plt.plot(times,xs_cont,"orange", label="PD Controlled Y coordinates")
